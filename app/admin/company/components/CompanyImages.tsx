...
// don't affect image data. onImageChange/onImageDelete are stable via useCallback.
export default memo(function CompanyImages({ data, onImageChange, onImageDelete }: CompanyImagesProps) {
  return (
    <div>
          ...
          <div key={key}>
            ...
            {data[key] && (
              <div className="relative inline-block mb-2">
                {/* [PERF] withCacheBust only runs when data[key] truthy — acceptable cost */}
