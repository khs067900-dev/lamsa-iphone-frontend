        ...
        {picks.map((p) => {
          ...
          return (
            <Link
              ...
              draggable={false}
              className="group flex-shrink-0 block w-[155px] sm:w-[215px] rounded-2xl sm:rounded-3xl overflow-hidden transition-all duration-300 hover:shadow-2xl border border-[#EBE6E2] hover:border-[#DFC4A4]/50"
